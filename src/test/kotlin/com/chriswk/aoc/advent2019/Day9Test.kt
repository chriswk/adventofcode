...
import com.chriswk.aoc.util.toChannel
...
class Day9Test {
    ...
    fun part1() {
        val day9 = Day9()
        assertThat(day9.part1(dayInputAsString(2019, 9))).isEqualTo(3063082071)
    }

    @Test
    fun part2() {
        val day9 = Day9()
        assertThat(day9.part2(dayInputAsString(2019, 9))).isEqualTo(81348)
    }
