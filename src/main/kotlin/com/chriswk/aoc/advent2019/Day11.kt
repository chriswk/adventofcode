...
class Day11 {
    ...
    private val program =
        parseBigInstructions(dayInputAsString(2019, 11)).withIndex().associate { it.index.toLong() to it.value }
            .toMutableMap()
    ...
    fun part2(): Unit {
        ...
        val min = ship.keys.minWithOrNull(Point.readOrder)!!
        val max = ship.keys.maxWithOrNull(Point.readOrder)!!
